...
void load(
        Archive & ar,
        binderd::testing::Benchmark::Result::Timing::Seconds& duration,
        const unsigned int)
{
    binderd::testing::Benchmark::Result::Timing::Seconds::rep value;
    ar & boost::serialization::make_nvp(kNameForSeconds, value);
    duration = binderd::testing::Benchmark::Result::Timing::Seconds{value};
}

template<class Archive>
void save(
        Archive & ar,
        const binderd::testing::Benchmark::Result::Timing::Seconds& duration,
        const unsigned int)
{
    binderd::testing::Benchmark::Result::Timing::Seconds::rep value = duration.count();
    ar & boost::serialization::make_nvp(kNameForSeconds, value);
}
...
void serialize(
        Archive & ar,
        std::pair<
            binderd::testing::Benchmark::Result::Timing::Seconds,
            double
        >& pair,
        const unsigned int)
{
...
template<class Archive>
void serialize(Archive & ar, binderd::testing::Benchmark::Result& result, const unsigned int)
{
