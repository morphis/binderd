...
#ifndef BINDER_COMMON_UTILS_H_
#define BINDER_COMMON_UTILS_H_
...
std::string to_string8(const std::u16string &str);
std::u16string to_string16(const std::string &str);
}  // namespace utils
}  // namespace binderd
...
template <typename... Types>
inline std::string binderd::utils::string_format(const std::string &format,
                                               Types &&... args) {
