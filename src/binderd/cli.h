...
#ifndef BINDER_CLI_H_
#define BINDER_CLI_H_

#include "binderd/common/do_not_copy_or_move.h"
#include "binderd/common/optional.h"
...
class Flag : public common::DoNotCopyOrMove {
 public:
...
class TypedFlag : public Flag {
 public:
  ...
  const common::Optional<T>& value() const { return value_; }
...
class OptionalTypedReferenceFlag : public Flag {
 ...
 private:
  std::reference_wrapper<common::Optional<T>> value_;
};
...
class Command : public common::DoNotCopyOrMove {
 public:
  // Safe us some typing
